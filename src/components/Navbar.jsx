...
const Navbar = () => {
  ...
  const nav_links = [
    { name: "Home", link: "/" },
    { name: "About", link: "/about-smartmaterials" },
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link: "/smartmaterials-conference-tracks/" },
    { name: "Orators", link: "/smartmaterials-orators" },
    { name: "Schedule", link: "/smartmaterials-event-schedule" },
          ...
          {nav_links.map((item, index) => (
            <Link
              ...
              className={`hover-underline-animation transition pb-1 ${location.pathname === item.link
                  ...
                  : "text-gray-700 hover:text-one border-b-2 border-transparent"
                }`}
              style={{
                marginRight: scrolled ? "0px" : "4px",
              }}
