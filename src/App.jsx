  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/smartmaterials-orators"  element={<Orators />} />
        <Route path="/about-smartmaterials"element={<AboutOralMed />} />
        <Route path="/smartmaterials-event-schedule"element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/smartmaterials-conference-tracks/"element={<RotatingLogos />} />
